...
# Başlangıç URL'si
base_url = "https://www.autotrader.ca/cars/on/toronto/?rcp=0&rcs={}&prx=100&prv=Ontario&loc=M5V%203L9&hprc=True&wcp=True&sts=New-Used&inMarket=basicSearch&make=BMW"
headers = {
...
while True:
    ...
    if response.status_code != 200:
        ...
        break  # Eğer sayfa yüklenemezse döngüyü kır
    else:
...
df.to_excel('BMW_3_series_dataset.xlsx', index=False)
