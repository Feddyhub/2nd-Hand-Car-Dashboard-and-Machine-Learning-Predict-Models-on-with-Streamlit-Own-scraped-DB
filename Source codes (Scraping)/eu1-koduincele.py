...
url = "https://www.autoscout24.com/lst/bmw?sort=standard&desc=0&ustate=N%2CU&atype=C&source=homepage_search-mask"
headers = {
...
if response.status_code != 200:
    ...
    price_elements = soup.find_all('p', {
        'class': 'Price_price__APlgs PriceAndSeals_current_price__ykUpx',
